...
Für größere Beispiele als lin318 wurde der randomisierte Algorithmus in Kombination mit 2-opt verwendet. Die erzielten Ergebnisse sind wahrscheinlich nicht reproduzierbar - jedoch sollten sich Laufzeit und Ergebnisqualität in der gleichen Größenordnung befinden. Der randomisierte Algorithmus wurde jeweils 5 mal  Bemerkenswert ist hier vor allem die Effektivität der 2-opt-Heuristik: Sie erlaubt
...
Wegen der Größe dieser Instanz ist eine graphische Darstellung nicht mehr sinnvoll, genauso wie das Abdrucken der Punktefolge. Die Lösung befindet sich aber im Ordner \verb|ausgaben| in der Datei \verb|pla85900.out|. Die Laufzeit betrug bei allen Ausführungen ca. 2 - 4 min. Bei der besten Lösung betrug die Länge der von \verb|randomized_obtuse_path| gefundenen Tour $1,86592 \cdot 10^{10}$, sie konnte von der 2-opt-Heuristik auf $2,37135 \cdot 10^9$ verkürzt werden.
