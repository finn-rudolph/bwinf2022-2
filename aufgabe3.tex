...
\emph{\textbf{Ein A*-basiertes Verfahren.}} Mit der unteren Schranke wird das Brute-Force Verfahren nun in zwei Aspekten verbessert.
...
\begin{proof}
    ...
    \begin{enumerate}
        \item Sei $i$ der Index des größten Elements von $p$, das nicht im sortierten Suffix liegt. Führe die Operation $\gamma_{i+1}$ aus. Damit wird das größte, noch nicht einsortierte Element nach vorne gebracht.
